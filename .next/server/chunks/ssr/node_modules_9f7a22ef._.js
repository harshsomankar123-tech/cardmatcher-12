...
async function recoverPublicKey({ hash, signature }) {
    ...
    const { secp256k1 } = await __turbopack_context__.A("[project]/node_modules/@walletconnect/universal-provider/node_modules/@noble/curves/esm/secp256k1.js [app-ssr] (ecmascript, async loader)");
    const signature_ = (()=>{
        // typeof signature: `Signature`
        if (typeof signature === 'object' && 'r' in signature && 's' in signature) {
            const { r, s, v, yParity } = signature;
...
//# sourceMappingURL=node_modules_9f7a22ef._.js.map